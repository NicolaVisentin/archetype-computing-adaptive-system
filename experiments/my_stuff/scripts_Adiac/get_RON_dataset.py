...
y_range = [-0.3, 0.3] # range of positions to sample. To have an idea about the ranges, take a look at test_RON_model.py
yd_range = [-0.25, 0.25] # range of velocities to sample. To have an idea about the ranges, take a look at test_RON_model.py
...
u = -2.1 + (2.7 - (-2.1)) * torch.rand((m, n_inp), device=device) # m samples u (scalar input in [-2.1, 2.7]). Shape (m, 1)
